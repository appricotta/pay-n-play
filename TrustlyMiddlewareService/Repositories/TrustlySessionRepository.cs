...
{
    Task<string> CreateSessionAsync(string messageId, string email, string currency, string? partnerId = null);
...
public class TrustlySessionRepository : ITrustlySessionRepository
{
    ...
    public async Task<string> CreateSessionAsync(string messageId, string email, string currency, string? partnerId = null)
    {
